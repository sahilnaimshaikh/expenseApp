...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'expenseType': PropertySchema(
      ...
      name: r'expenseType',
      type: IsarType.byte,
      enumMap: _ExpenseexpenseTypeEnumValueMap,
    ),
...
void _expenseSerialize(
  ...
  writer.writeByte(offsets[5], object.expenseType.index);
  writer.writeInt(offsets[6], object.paymentMethod?.index);
...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    ...
    expenseType:
        _ExpenseexpenseTypeValueEnumMap[reader.readByteOrNull(offsets[5])] ??
            ExpenseType.personal,
    paymentMethod:
        _ExpensepaymentMethodValueEnumMap[reader.readIntOrNull(offsets[6])],
    tags: reader.readStringList(offsets[7]) ?? const <String>[],
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (_ExpenseexpenseTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          ExpenseType.personal) as P;
    case 6:
      return (_ExpensepaymentMethodValueEnumMap[reader.readIntOrNull(offset)])
          as P;
    case 7:
...
const _ExpenseexpenseTypeEnumValueMap = {
  'personal': 0,
  'home': 1,
};
const _ExpenseexpenseTypeValueEnumMap = {
  0: ExpenseType.personal,
  1: ExpenseType.home,
};
const _ExpensepaymentMethodEnumValueMap = {
  'cash': 0,
  'upi': 1,
  'debitCard': 2,
  'creditCard': 3,
...
const _ExpensepaymentMethodValueEnumMap = {
...
extension ExpenseQueryWhereSort on QueryBuilder<Expense, Expense, QWhere> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhere> anyCategoryId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhere> anyExpenseType() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Expense, Expense, QAfterWhere> anyPaymentMethod() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ExpenseQueryWhere on QueryBuilder<Expense, Expense, QWhereClause> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> categoryIdEqualTo(
      int categoryId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> categoryIdNotEqualTo(
      int categoryId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> categoryIdGreaterThan(
    int categoryId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> categoryIdLessThan(
    int categoryId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> categoryIdBetween(
    int lowerCategoryId,
    int upperCategoryId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseTypeEqualTo(
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseTypeNotEqualTo(
      ExpenseType expenseType) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseTypeGreaterThan(
    ExpenseType expenseType, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseTypeLessThan(
    ExpenseType expenseType, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseTypeBetween(
    ExpenseType lowerExpenseType,
    ExpenseType upperExpenseType, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'paymentMethod',
        lower: [null],
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodEqualTo(
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodNotEqualTo(
      PaymentMethod? paymentMethod) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodGreaterThan(
    PaymentMethod? paymentMethod, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodLessThan(
    PaymentMethod? paymentMethod, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> paymentMethodBetween(
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByExpenseType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expenseType', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByExpenseTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByExpenseType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expenseType', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByExpenseTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expenseType', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByExpenseType() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, ExpenseType, QQueryOperations> expenseTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'expenseType');
    });
  }

  QueryBuilder<Expense, PaymentMethod?, QQueryOperations>
